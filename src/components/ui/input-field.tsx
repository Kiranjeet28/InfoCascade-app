...
export default function InputField({
    ...
    return (
        <View style={{ marginBottom: error || helperText ? 20 : 16 }}>
            ...
            <Animated.View
                style={{
                    flexDirection: 'row', alignItems: multiline ? 'flex-start' : 'center', borderWidth: 1.5,
                    borderRadius: 14, backgroundColor: colors.surface,
                    paddingHorizontal: 16, paddingVertical: multiline ? 12 : 0, height: multiline ? undefined : 54,
                    borderColor,
                }}
            >
                {icon && (
