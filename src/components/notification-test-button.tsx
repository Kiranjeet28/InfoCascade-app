...
export default function NotificationTestButton({
    ...
    const handleSendNotification = async () => {
        if (!expoPushToken) {
            Alert.alert('Error', 'Push token not available. Please make sure you have granted notification permissions.');
            return;
        }
        ...
        try {
            await sendPushNotification(
                expoPushToken,
                'Test Notification',
                'This is a test notification from your Infocascade app!'
            );
