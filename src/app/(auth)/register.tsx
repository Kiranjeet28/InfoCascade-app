...
export default function RegisterScreen() {
  ...
  useEffect(() => {
    ...
    checkAvailabilityDebounced(
      ...
      300,
    ); // Reduced from 400ms to 300ms for faster feedback
  }, [urn]);
  ...
  useEffect(() => {
    if (department) {
      fetchGroups(department).then((list) => {
        setGroups(list);
        setGroup("");
      });
    } else {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Handle duplicate/conflict errors (duplicate URN, CRN, or email)
        ...
        const errorMsg =
          data.error ?? data.message ?? "This data is already registered";
        showMessage(errorMsg, "error");
      ...
      // Handle other errors
        ...
        showMessage(
          "Backend endpoint not found. Check server or endpoint path.",
          "error",
        );
        ...
        {msg && (
          <View
            style={{
              ...
              alignItems: "center",
              backgroundColor:
                msg.type === "success" ? "#00D9AA25" : "#FF4D6D25",
              borderWidth: 1,
              borderColor:
                msg.type === "success" ? colors.accent : colors.error,
            }}
          >
            <Text
              style={{
        ...
        >
                ...
                <View style={{ marginBottom: 16, paddingHorizontal: 2 }}>
                  ...
                  {emailAvailability.status === "available" && (
                    ...
                    >
                      ...
                      >
                        {emailAvailability.message || "Available"}
                      </Text>
                    </View>
                  )}
                  {emailAvailability.status === "taken" && (
                    ...
                    >
                      ...
                      >
                        {emailAvailability.message || "Already registered"}
                      </Text>
                    </View>
                  )}
                  {emailAvailability.status === "error" && (
                    ...
                    >
                      ...
                      >
                        {emailAvailability.message || "Unable to validate"}
                      </Text>
                    </View>
                  )}
                </View>
              ...
              <View style={{ flexDirection: "row", gap: 10 }}>
                ...
                <TouchableOpacity
                  style={[
                    btn,
                    { flex: 1 },
                    (otp.length !== 6 || loading) && btnDisabled,
                  ]}
          ...
          {step === 2 && (
            <View style={card}>
              ...
              />
              <InputField
                label="URN (University Roll) - 7 digits only"
                value={urn}
                onChangeText={(text) =>
                  setUrn(text.replace(/[^0-9]/g, "").slice(0, 7))
                }
              ...
              <InputField
                label="CRN (Class Roll) - 7 digits only"
                value={crn}
                onChangeText={(text) =>
                  setCrn(text.replace(/[^0-9]/g, "").slice(0, 7))
                }
                placeholder="e.g. 1234567"
                icon={{
              ...
              <InputField
                ...
                placeholder="Min 8 characters (letter, number, special char)"
                        ...
                        >
                          <View
                            style={{
                              ...
                              height: 16,
                              borderRadius: 8,
                              backgroundColor: checks.hasAlphabet
                                ? colors.accent
                                : colors.border,
                            }}
                          />
                        ...
                        >
                          <View
                            style={{
                              ...
                              height: 16,
                              borderRadius: 8,
                              backgroundColor: checks.hasNumber
                                ? colors.accent
                                : colors.border,
                            }}
                          />
                        ...
                        >
                          <View
                            style={{
                              ...
                              height: 16,
                              borderRadius: 8,
                              backgroundColor: checks.hasSpecialChar
                                ? colors.accent
                                : colors.border,
                            }}
                          />
                        ...
                        >
                          <View
                            style={{
                              ...
                              height: 16,
                              borderRadius: 8,
                              backgroundColor: checks.isLongEnough
                                ? colors.accent
                                : colors.border,
                            }}
                          />
                          ...
                          >
                            {checks.isLongEnough ? "✓" : "○"} At least 8
                            characters
                          </Text>
                        </View>
                      </>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    if (urnStatus === "checking" || crnStatus === "checking") {
                      Alert.alert(
                        "Validating",
                        "Please wait for URN and CRN validation to complete",
                      );
                      return;
                    }
                    if (
                      ...
                      Alert.alert(
                        "Validation Error",
                        "Please fix URN and CRN validation issues",
                      );
                      return;
                    }
                    if (!isPasswordStrong(password)) {
              ...
              <View style={{ flexDirection: "row", gap: 10, marginTop: 20 }}>
                ...
                <TouchableOpacity
                  style={[
                    btn,
                    { flex: 1 },
                    (loading || !department) && btnDisabled,
                  ]}
