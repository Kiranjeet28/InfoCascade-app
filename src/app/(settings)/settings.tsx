...
export default function SettingsScreen() {
  ...
  // Reminder options modal (previously referenced but not defined -> crash)
  const [showReminderOptions, setShowReminderOptions] = useState(false);

  // Local-only preferences for reminder time (kept minimal to prevent crash)
              ...
              {(["system", "light", "dark"] as ThemeMode[]).map((mode) => (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    marginBottom: 8,
                    backgroundColor:
                      themeMode === mode ? colors.primary + "20" : colors.bg,
